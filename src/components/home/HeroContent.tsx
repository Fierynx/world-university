...
const HeroContent = () => {
  return (
    <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white bg-black bg-opacity-60 pb-10 gap-3">
      ...
      <p className="text-xs md:text-sm lg:text-lg mb-8 w-3/4">
      ...
      <Link to="/country-filter-search" className="bg-gradient-to-r mt-1 from-accent to-yellow-500 text-black font-bold py-4 px-8 rounded-full shadow-lg hover:shadow-xl hover:from-yellow-600 hover:to-yellow-700 transition duration-300 active:opacity-30">
        Get Started
      </Link>
    </div>
  );
