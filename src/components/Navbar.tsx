    ...
    <nav className="bg-primary shadow-md fixed left-0 right-0 top-0 z-50">
      <div className="container py-5 flex justify-between items-center px-4 md:px-8">
        ...
        <div className="hidden md:flex gap-10">
          ...
          <Link to="/country-search" className="text-white hover:text-accent transition duration-300">Country Search</Link>
          <Link to="/country-filter" className="text-white hover:text-accent transition duration-300">Country Filter</Link>
